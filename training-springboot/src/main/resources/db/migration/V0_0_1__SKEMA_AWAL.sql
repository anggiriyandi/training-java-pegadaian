...
create table s_user (id_group varchar(36) not null, fullname varchar(255), username varchar(255), primary key (id_group)) engine=MyISAM;
...
alter table s_user_password add constraint FKawyesj4b8c49ofvrmpa3lx3lv foreign key (id_user) references s_user (id_group);
